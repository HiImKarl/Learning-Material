A simple templated AVL tree implementation in C++. Nodes are not wrapped in an additonal tree class, but an API is exposed that allows the nodes to be worked with directly.
